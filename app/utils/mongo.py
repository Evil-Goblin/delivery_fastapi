...
def create_client(host: str = "localhost", port: int = 27017, event_loop: AbstractEventLoop | None = None) -> Any:
...
def get_client(event_loop: AbstractEventLoop | None = None) -> Any:
    global __client
    if __client is None:
...
def get_db(event_loop: AbstractEventLoop | None = None) -> Any:
    global __db
    if __db is None:
...
__db: Any | None = None  # client[DATABASE_NAME]
